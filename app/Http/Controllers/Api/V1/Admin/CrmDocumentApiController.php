...
class CrmDocumentApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new CrmDocumentResource(CrmDocument::with(['customer', 'requested_products'])->get());
    }
    ...
    public function show(CrmDocument $crmDocument)
    {
        ...
        return new CrmDocumentResource($crmDocument->load(['customer', 'requested_products']));
    }
