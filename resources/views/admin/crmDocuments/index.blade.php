                ...
                <tbody>
                    @foreach($crmDocuments as $key => $crmDocument)
                        <tr data-entry-id="{{ $crmDocument->id }}">
                            ...
                            <td>
                                @foreach($crmDocument->requested_products as $key => $item)
                            ...
                            <td>
                                <span style="display:none">{{ $crmDocument->quotation_is_signed ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $crmDocument->quotation_is_signed ? 'checked' : '' }}>
                            </td>
                            <td>
                                <span style="display:none">{{ $crmDocument->quotation_is_new ?? '' }}</span>
