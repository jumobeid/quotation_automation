...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Requested Products
    Route::delete('requested-products/destroy', 'RequestedProductsController@massDestroy')->name('requested-products.massDestroy');
    Route::resource('requested-products', 'RequestedProductsController');
});
